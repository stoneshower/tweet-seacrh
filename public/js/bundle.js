...
var Tweets_1 = __webpack_require__(27);
...
var App = /** @class */ (function (_super) {
    ...
    function App() {
        ...
        _this.handleChange = function (e) {
            _this.setState(__assign({}, _this.state, { keyword: e.target.value }));
        };
        _this.handleChaneHash = function (e) {
            _this.setState(__assign({}, _this.state, { hashtag: e.target.value }));
        };
        _this.handleCallApi = function (e) {
            e.preventDefault();
            ...
            var request = function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, response, json, response, json;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this.state.searchMode;
                            switch (_a) {
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 7];
                        case 4: return [4 /*yield*/, fetch("/tweet_user?q=" + this.state.keyword, option)];
                        case 5:
                            response = _b.sent();
                            return [4 /*yield*/, response.json()];
                        case 6:
        ...
        _this.updateSearchMode = function (e) {
            _this.setState({
...
var Tweets = /** @class */ (function (_super) {
    ...
    Tweets.prototype.render = function () {
        ...
        if (this.props.searchMode === '') {
            ...
            outputTweet = (React.createElement("div", { className: styles.panelWrapper }, this.props.tweets
                ...
                return (React.createElement("article", { key: index + '_panel', className: styles.panel },
                    React.createElement("ul", { key: index + '_panelInner', className: styles.panelInner },
                        React.createElement("li", { key: index + '_text' }, tweet.full_text),
                        React.createElement("li", { key: index + '_profileWrap', className: styles.profile },
                            ...
                            React.createElement("ul", { className: styles.profile_descr },
                                React.createElement("li", { key: index + '_description' }, tweet.user.description)),
            ...
            outputTweet = (React.createElement("div", { className: styles.panelWrapper }, this.props.tweetsUser
                .map(function (tweet, index) {
                return (React.createElement("article", { key: index + '_panel', className: styles.panel + " " + styles.panelOfUser },
                    React.createElement("ul", { key: index + '_panelInner', className: styles.panelInner },
                        React.createElement("li", { key: index + '_profileWrap', className: styles.profile },
                            React.createElement("ul", { className: styles.profile_main },
                                React.createElement("li", { key: index + '_profile_image_url' },
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:8]!./tweets.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:8]!./tweets.css");
...
// module
exports.push([module.i, ".tweets__panel__2CshSaBb{\n  border: 1px solid #EDEDED;\n  box-sizing: border-box;\n}\n.tweets__panelInner__aFt77pqY{\n  padding: 1em;\n  word-break: break-word;\n  list-style: none;\n  margin: 0;\n  padding: 0;\n}\n.tweets__panelInner__aFt77pqY li{\n  font-family: Roboto;\n  color: #A8A8A8;\n  font-size: 12px;\n  font-weight: 400;\n}\n.tweets__panelInner__aFt77pqY > li:first-child{\n  font-size: 14px;\n  line-height: 1.4;\n  color: #898989;\n  border-bottom: 1px solid #EDEDED;\n  margin-bottom: 8px;\n  padding-bottom: 8px;\n}\n.tweets__panelOfUser__1GyRRiPX .tweets__panelInner__aFt77pqY > li:first-child{\n  border-bottom: none;\n}\n.tweets__panelWrapper__Nq4LckZS{\n  display: flex;\n  flex-wrap: wrap;\n}\n.tweets__panelWrapper__Nq4LckZS article{\n  flex: 1 1 25%;\n  max-width: 25%;\n  padding: 12px 8px;\n}\n@media(max-width: 480px){\n  .tweets__panelWrapper__Nq4LckZS article{\n    flex: 1 1 50%;\n    max-width: 50%;\n    padding: 12px 8px;\n  }\n}\n.tweets__profile__1WZDoLcG{\n  display: display;\n}\n.tweets__profile__1WZDoLcG ul{\n  list-style: none;\n  padding: 0;\n}\n.tweets__profile_main__1k2kpVha,\n.tweets__profile_count__22IAmN0M,\n.tweets__profile_sub__2BEYtTgZ{\n  display: flex;\n  flex-wrap: wrap;\n}\n.tweets__profile_main__1k2kpVha li,\n.tweets__profile_count__22IAmN0M li,\n.tweets__profile_sub__2BEYtTgZ li{\n  flex: 1 1 50%;\n  max-width: 50%;\n}\n.tweets__profile_descr__1Dc1zdZ5{\n  display: block;\n}\n.tweets__profile_main__1k2kpVha{\n  align-items: center;\n}\n.tweets__profile_main__1k2kpVha li:first-child{\n  flex: 0 0 40px;\n}\n.tweets__profile_main__1k2kpVha li:nth-child(2){\n  flex: 1 1 auto;\n  padding-left: 8px;\n}", ""]);

// exports
exports.locals = {
	"panel": "tweets__panel__2CshSaBb",
	"panelInner": "tweets__panelInner__aFt77pqY",
	"panelOfUser": "tweets__panelOfUser__1GyRRiPX",
	"panelWrapper": "tweets__panelWrapper__Nq4LckZS",
	"profile": "tweets__profile__1WZDoLcG",
	"profile_main": "tweets__profile_main__1k2kpVha",
	"profile_count": "tweets__profile_count__22IAmN0M",
	"profile_sub": "tweets__profile_sub__2BEYtTgZ",
	"profile_descr": "tweets__profile_descr__1Dc1zdZ5"
};
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:8]!./search.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:8]!./search.css");
...
// exports
exports.locals = {
	"form": "search__form__2d6JATi7",
	"selectWrapper": "search__selectWrapper__dVSKs3wS",
	"selectOptions": "search__selectOptions__1JUWBadJ",
	"select": "search__select__ezyRh9oz",
	"inputText": "search__inputText__35jPN5_P",
	"submit": "search__submit__22zonck0"
};
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:8]!./app.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:8]!./app.css");
